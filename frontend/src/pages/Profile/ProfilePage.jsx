        ...
        <div className="p-6 space-y-6">
          ...
          <div className="pt-6 border-t border-slate-200">
            ...
            <div className="space-y-4">
              ...
              <TextareaField label="Address" name="address" icon={MapPin} value={formData.address} onChange={handleInputChange} placeholder="123 MainSt, Anytown, India" />
              <InputField label="Phone" name="phone" icon={Phone} type="tel" value={formData.phone} onChange={handleInputChange} placeholder="(+91) 123-456-7890" />
            </div>
          </div>
        </div>
