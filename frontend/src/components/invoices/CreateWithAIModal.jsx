  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto">
      <div className="flex items-center justify-center min-h-screen px-4 text-center">
        ...
        {/* Modal */}
        <div className="bg-white rounded-lg shadow-xl max-w-lg w-full p-6 relative text-left transform transition-all z-10">
          {/* Header */}
          ...
          <div className="space-y-4">
            <p className="text-sm text-slate-600">
              ...
              quantities and prices) and the AI will attempt to create an invoice
              from it.
            </p>
