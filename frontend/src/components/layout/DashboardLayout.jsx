...
const DashboardLayout = ({ children, activeMenu = "dashboard" }) => {
  ...
  const sidebarCollapsed = false; // can be extended later
  ...
  const sidebarTransformClass = isMobile && !sidebarOpen
    ? "-translate-x-full"
    : "translate-x-0";
  ...
  return (
    <div className="flex h-screen bg-gray-50">
      ...
      {/* Sidebar */}
      <div
        className={`fixed inset-y-0 left-0 z-50 transition-transform duration-300 ${isMobile
          ? sidebarOpen
            ? "translate-x-0"
            : "-translate-x-full"
          : "translate-x-0"
        ...
        <div className="flex items-center h-16 border-b border-gray-200 px-6">
          <Link to="/dashboard" className="flex items-center space-x-3">
            <div className="h-8 w-8 bg-gradient-to-br from-blue-900 to-blue-700 rounded-lg flex items-cemter justify-center ">
